...
def get_pie_chart(entered_site):
    ...
    if entered_site =='ALL':
        ...
        # Logic for a specific site:
        # 1. Filter the dataframe for the selected site
        filtered_df = spacex_df[spacex_df['Launch Site'] == entered_site]
        
        # 2. Group by 'class' to get counts of 0 (fail) and 1 (success)
        # We create a simple count column to give px.pie something to calculate
...
def get_scatter_chart(entered_site, payload_range):
    # 1. Filter the dataframe based on the payload slider range
    # payload_range is a list like [0, 10000]
    ...
    if entered_site == 'ALL':
        ...
        # 2. Filter the already payload-filtered dataframe for the specific site
